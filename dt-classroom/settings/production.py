...
from dt-classroom.settings.base import *
from dt-classroom.settings.utils import get_env_setting
...
# This may be overridden by the YAML in dt-classroom_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

CONFIG_FILE = get_env_setting('DT-CLASSROOM_CFG')
