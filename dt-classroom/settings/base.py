...
from dt-classroom.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('DT-CLASSROOM_SECRET_KEY', 'insecure-secret-key')
...
PROJECT_APPS = (
    'dt-classroom.apps.core',
    'dt-classroom.apps.api',
)
...
ROOT_URLCONF = 'dt-classroom.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'dt-classroom.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'dt-classroom.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'dt-classroom_sessionid'
CSRF_COOKIE_NAME = 'dt-classroom_csrftoken'
LANGUAGE_COOKIE_NAME = 'dt-classroom_language'
