...
"""
talenthub documentation build configuration file.
...
VERSION = get_version("../talenthub", "__init__.py")
...
html_context = {
    ...
    "github_repo": "talenthub",  # Repo name
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call(
        [
            ...
            "-o",
            docs_path,
            os.path.join(root_path, "talenthub"),
            os.path.join(root_path, "talenthub/migrations"),
        ]
    )
