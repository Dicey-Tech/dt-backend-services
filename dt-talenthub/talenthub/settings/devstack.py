from talenthub.settings.local import *

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.mysql",
        "NAME": os.environ.get("DB_NAME", "talenthub"),
        "USER": os.environ.get("DB_USER", "root"),
        "PASSWORD": os.environ.get("DB_PASSWORD", ""),
        "HOST": os.environ.get("DB_HOST", "talenthub.db"),
...
SOCIAL_AUTH_EDX_OAUTH2_KEY = os.environ.get(
    "SOCIAL_AUTH_EDX_OAUTH2_KEY", "talenthub-sso-key"
)
SOCIAL_AUTH_EDX_OAUTH2_SECRET = os.environ.get(
    "SOCIAL_AUTH_EDX_OAUTH2_SECRET", "talenthub-sso-secret"
)
...
BACKEND_SERVICE_EDX_OAUTH2_KEY = os.environ.get(
    "BACKEND_SERVICE_EDX_OAUTH2_KEY", "talenthub-backend-service-key"
)
BACKEND_SERVICE_EDX_OAUTH2_SECRET = os.environ.get(
    "BACKEND_SERVICE_EDX_OAUTH2_SECRET", "talenthub-backend-service-secret"
)
