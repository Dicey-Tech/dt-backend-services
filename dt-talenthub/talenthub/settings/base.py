...
from talenthub.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get("TALENTHUB_SECRET_KEY", "insecure-secret-key")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": (
                ...
                "talenthub.apps.core.context_processors.core",
            ),
...
SESSION_COOKIE_NAME = "talenthub_sessionid"
CSRF_COOKIE_NAME = "talenthub_csrftoken"
LANGUAGE_COOKIE_NAME = "talenthub_language"
