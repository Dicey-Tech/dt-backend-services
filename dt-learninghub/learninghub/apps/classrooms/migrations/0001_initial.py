            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Specifies the displayed name of the classroom",
                        max_length=255,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="classrooms.ClassroomFeatureRole",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "course_id",
                    models.CharField(
                        help_text="Unique identifier for the course", max_length=255
                    ),
                ),
                (
                    "classroom_instance",
                    models.ForeignKey(
                        blank=True,
                        help_text="The classroom to which this assignment is attached",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_id",
                    models.EmailField(
                        db_index=True, help_text="User identifier", max_length=254
                    ),
                ),
                ...
                (
                    "classroom_instance",
                    models.ForeignKey(
                        help_text="The classroom to which this enrollment is attached",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="classrooms.Classroom",
                    ),
                ),
