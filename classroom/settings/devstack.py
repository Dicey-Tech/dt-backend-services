from classroom.settings.local import *
...
SOCIAL_AUTH_EDX_OAUTH2_KEY = os.environ.get(
    "SOCIAL_AUTH_EDX_OAUTH2_KEY", "classroom-sso-key"
)
SOCIAL_AUTH_EDX_OAUTH2_SECRET = os.environ.get(
    "SOCIAL_AUTH_EDX_OAUTH2_SECRET", "classroom-sso-secret"
)
...
BACKEND_SERVICE_EDX_OAUTH2_KEY = os.environ.get(
    "BACKEND_SERVICE_EDX_OAUTH2_KEY", "classroom-backend-service-key"
)
BACKEND_SERVICE_EDX_OAUTH2_SECRET = os.environ.get(
    "BACKEND_SERVICE_EDX_OAUTH2_SECRET", "classroom-backend-service-secret"
)
