    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('classroom_instance', models.ForeignKey(blank=True, help_text='The classroom to which this enrollment is attached', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='classrooms', related_query_name='classroom', to='classroom.Classroom')),
            ],
            options={
                'ordering': ['created'],
